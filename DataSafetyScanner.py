...
SENSITIVE_PATTERNS = [
    ...
    {
        "name": "证件号/账户",
        "pattern": r'(?:证件号|证件号码|账户\s*(?:号|号码)|账号|帐号)\s*[：:]\s*\S{4,}',
        "description": "各类证件号码或账户标识",
        "risk": "高",
        "color": "#e74c3c"
    },
    {
        "name": "密码/验证码",
        "pattern": r'(?:密码|验证码|校验码|动态码)\s*[：:]\s*\S{4,}',
        "description": "密码或短信验证码等认证信息",
        "risk": "高",
        "color": "#e74c3c"
    },
    {
        "name": "定位/轨迹",
        "pattern": r'(?:定位|地理位置|GPS坐标|经纬度|轨迹|行程|行动轨迹)\s*[：:]\s*\S{4,}',
        "description": "定位信息或行动轨迹",
        "risk": "高",
        "color": "#e74c3c"
    },
    {
        "name": "生物识别",
        "pattern": r'(?:人脸|指纹|虹膜|声纹|掌纹|面部识别|指纹识别|生物特征|生物识别)\s*(?:[：:]\s*\S{2,}|信息|数据|记录)',
        "description": "人脸、指纹、虹膜等生物识别信息",
        "risk": "高",
        "color": "#e74c3c"
    },
    {
        "name": "医疗/病历",
        "pattern": r'(?:病历|病史|就诊记录|住院记录|诊断结果|检查报告|病例|医疗记录|健康档案)\s*(?:[：:]\s*\S{2,}|信息|数据|记录)',
        "description": "医疗病历、就诊记录等健康信息",
        "risk": "高",
        "color": "#e74c3c"
    },
    {
        "name": "征信/贷款/流水",
        "pattern": r'(?:征信|征信报告|信用报告|贷款|借贷|信贷|交易流水|流水记录|银行流水|收支明细)\s*(?:[：:]\s*\S{2,}|信息|数据|记录|单)',
        "description": "征信报告、贷款信息、银行流水等金融信息",
        "risk": "高",
        "color": "#e74c3c"
    },
    {
        "name": "薪资/收入",
        "pattern": r'(?:薪资|工资|薪酬|收入|薪水|月薪|年薪|待遇|工资条|工资单)\s*(?:[：:]\s*\S{2,}|信息|数据|单)',
        "description": "薪资收入等财务信息",
        "risk": "高",
        "color": "#e74c3c"
    },
    {
        "name": "未成年人信息",
        "pattern": r'(?:未成年人|未成年|儿童信息|学生信息|幼儿|青少年)\s*(?:信息|数据|资料|名单|隐私)',
        "description": "未成年人个人信息",
        "risk": "高",
        "color": "#e74c3c"
    },
]
